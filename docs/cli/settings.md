...
| Mouse Events                         | `ui.mouseEvents`                       | Controls terminal mouse tracking in alternate buffer mode. Auto disables mouse tracking in touch-oriented terminals such as Termux.                               | `"auto"` |
